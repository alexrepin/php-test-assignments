...
- При наличии суммы комиссий она должна прикрепляться к стороне зачисления. Например: клиент переводит **100$** с счета **А** на счет **Б**. Комиссия для него составляет **10%**, соответсвенно с счета **А** будет списано **100$,** а на счет **Б** зачислено **90$**, **10$** — комиссия.
